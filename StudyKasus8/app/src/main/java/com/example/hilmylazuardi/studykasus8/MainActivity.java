...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sepeda =
                getResources().getStringArray(R.array.sepeda_array);
        Spinner s1 = (Spinner) findViewById(R.id.spinner);
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, sepeda);
    ...
    public void tampilSecondActivity(View view) {
        ...
        Intent intentSecondActivity = new Intent( this, SecondActicity.class );

        TextView txtpemesan = findViewById(R.id.txtpemesan);
        Spinner txtsepeda= findViewById(R.id.spinner);
        ...
        String strsepeda = txtsepeda.getSelectedItem().toString();
        ...
        if (txtpemesan.getText().toString().trim().equals("")){
        ...
        } else if (txtsepeda.getSelectedItem().toString().isEmpty()) {
            txtjam.setError("Jenis Sepeda Tidak Boleh Kosong");
            ...
            txttanggal.setError("Tanggal Rental Tidak Boleh Kosong");
        } else {
            intentSecondActivity.putExtra( "pesan", strpemesan);
            intentSecondActivity.putExtra( "sepeda", strsepeda);
